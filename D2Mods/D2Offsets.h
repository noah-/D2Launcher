...
#define FUNCPTR(d1, v1, t1, t2, o1)                                                                                                                                      \
    ...
    d1##_##v1##_t* d1##_##v1 = (d1##_##v1##_t*)((DWORD)GetModuleHandleW( nullptr ) + o1);
#define VARPTR(d1, v1, t1, o1)                                                                                                                                           \
    typedef t1 d1##_##v1##_t;                                                                                                                                            \
    d1##_##v1##_t* p_##d1##_##v1 = (d1##_##v1##_t*)((DWORD)GetModuleHandleW( nullptr ) + o1);
#define ASMPTR(d1, v1, o1) DWORD d1##_##v1 = (DWORD)GetModuleHandleW( nullptr ) + o1;
    ...
    ASMPTR(D2CLIENT, LoadAct_2, 0x59150)
...
bool ClickMap(DWORD dwClickType, int wX, int wY) {
    ...
    *p_D2CLIENT_MouseX = 0;
    *p_D2CLIENT_MouseY = 0;
    D2CLIENT_ClickMap(dwClickType, Click.x, Click.y, 0);
